...
/* Generated from ../O.Common/julaboCP450.dbd */
...
int julaboCP450_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/epics/FHI/julaboCP450";
...
/* julaboCP450_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: julaboCP450_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(julaboCP450_registerRecordDeviceDriver(*iocshPpdbbase));
}
