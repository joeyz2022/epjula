...
/* Generated from ../O.Common/reaktor.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_asynInt8ArrayAai,
    ...
    *pvar_dset_devmbbiStream, *pvar_dset_devCasterMBBIState,
    ...
    *pvar_dset_devCasterSIMsg, *pvar_dset_devSoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devmbbiStream", "devCasterMBBIState", "devMbbiDirectSoft",
    ...
    "asynSiOctetRead", "devstringinStream", "devCasterSIMsg", "devSoSoft",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devCasterMBBIState, pvar_dset_devMbbiDirectSoft,
    ...
    pvar_dset_devstringinStream, pvar_dset_devCasterSIMsg,
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_drvModbusAsynRegister, pvar_func_editSseqRegistrar,
    ...
    pvar_func_utagInitialize, pvar_func_register_func_readFloat,
    pvar_func_register_func_writeFloat;
...
int reaktor_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/epics/FHI/epics-ioc/reaktor";
    ...
    runRegistrarOnce(pvar_func_register_func_readFloat);
    runRegistrarOnce(pvar_func_register_func_writeFloat);
    iocshRegisterVariable(vardefs);
    return 0;
}

/* reaktor_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: reaktor_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(reaktor_registerRecordDeviceDriver(*iocshPpdbbase));
}
